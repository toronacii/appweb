...
CASE WHEN convenio.id_transaction ISNULL THEN FALSE ELSE TRUE END AS convenio,
CASE WHEN fraccionamiento.id_transaction ISNULL THEN FALSE ELSE TRUE END AS fraccionamiento,
